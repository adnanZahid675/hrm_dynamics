  ...
  components: {
    TextInput: TextInput.extend({
      classNames: (_theme, props) => ({
        input: clsx(
          props.error
            ? 'border-error-600 focus:shadow-error text-gray-900 placeholder:text-gray-500'
            : 'focus:shadow-test border-gray-300 focus:border-brand-300',
          'rounded-lg placeholder:text-gray-500 h-[44px] shadow-input text-md-regular'
        ),
